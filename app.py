...
"""
============================================================================
 Chatbot Boursier - Application Streamlit complète
============================================================================
Auteur   : Assistant IA (Claude)
Objectif : Transformer un chatbot NLTK basique en une application web
           moderne, sécurisée et interactive dédiée à l'apprentissage
           du marché boursier.

Fonctionnalités principales :
    1. Authentification simple via st.session_state
    2. Design UI/UX moderne avec CSS personnalisé injecté
    3. Interface de chat façon "ChatGPT" (st.chat_message / st.chat_input)
    4. Dashboard boursier simulé (widgets st.metric)
    5. Barre latérale interactive (raccourcis + glossaire + déconnexion)
